# Elementary — data observability for globex/globex-eu
...
```bash
pf seed globex globex-eu                     # every build records itself
pf tool elementary run globex globex-eu      # first time: create the tables
pf tool elementary report globex globex-eu   # render the HTML report
pf tool elementary serve globex globex-eu    # read it in a browser
```
