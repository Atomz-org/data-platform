...
okf_x_kg_node: metric:mcx_commodity_rs_var_days
---

# Definition

* **Kind:** `simple`
* **Expression:** `count(var_rogers_satchell)`
...
* **Derived from it:** [mcx_commodity_rs_variance](/metrics/mcx_commodity_rs_variance.md)
