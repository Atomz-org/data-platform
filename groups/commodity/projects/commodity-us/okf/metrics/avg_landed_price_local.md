...
* **Built from:** [landed_price_days](/metrics/landed_price_days.md), [landed_price_local_total](/metrics/landed_price_local_total.md)
* **Derived from it:** [landed_price_mom_change](/metrics/landed_price_mom_change.md)
