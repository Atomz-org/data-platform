...
| **group** | **here** | what every sister in hospital agrees on |
...
```
    ...
    pf evals hospital <project>          # contract tier + load every case
    pf evals hospital <project> --live   # grade against the real models
