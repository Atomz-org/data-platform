...
5 groups · 9 projects · 23 toolkits · 24 pinned upstreams · 809 tests
...
flowchart TB
  subgraph SHARED["platform/ — shared by every project, never edited per company"]
    ...
    TST["tests/<br/>5 groups · 809 tests"]
    ENT["entrypoints/<br/>container entrypoints"]
  end

  subgraph ENTITIES["groups/ — 5 groups, 9 projects"]
    direction LR
...
|---|--:|--:|--:|--:|--:|--:|
| `acme/acme-eu` | 3 | 0 | 0 | 0 | 10 | 139 |
| `acme/acme-rollup` | 0 | 0 | 0 | 0 | 10 | 112 |
| `acme/acme-us` | 3 | 0 | 0 | 0 | 10 | 140 |
| `commodity/commodity-india` | 4 | 15 | 16 | 19 | 10 | 536 |
| `globex/globex-core` | 0 | 0 | 0 | 0 | 10 | 99 |
| `globex/globex-eu` | 0 | 0 | 0 | 0 | 10 | 99 |
| `jaffle/jaffle-shop` | 57 | 0 | 0 | 0 | 10 | 709 |
| `zenith/zenith-de` | 0 | 0 | 0 | 0 | 10 | 99 |
| `zenith/zenith-uk` | 0 | 0 | 0 | 0 | 10 | 99 |
