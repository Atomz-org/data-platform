...
<LineChart data={series} x=metric_time y=benchmark_price_usd_total yFmt=num0/>
...
<BarChart data={by_dim} x=commodity_id y=benchmark_price_usd_total swapXY=true xFmt=num0/>
