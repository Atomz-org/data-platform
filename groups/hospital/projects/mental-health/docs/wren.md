# Wren — semantic layer for hospital/mental-health
...
```bash
pf tool wren mdl hospital mental-health          # what the manifest contains
pf tool wren plan hospital mental-health "<sql>" # expand SQL through the MDL
pf tool wren query hospital mental-health "<sql>"
pf tool doctor hospital mental-health            # is the engine actually usable
```
