...
okf_x_kg_node: metric:mcx_rs_vol_30d_total
---

# Definition

* **Kind:** `simple`
* **Expression:** `sum(rogers_satchell_vol_30d)`
...
* **Derived from it:** [avg_mcx_rogers_satchell_vol_30d](/metrics/avg_mcx_rogers_satchell_vol_30d.md)
