...
| **group** | **here** | what every sister in acme agrees on |
...
```
    ...
    pf evals acme <project>          # contract tier + load every case
    pf evals acme <project> --live   # grade against the real models
