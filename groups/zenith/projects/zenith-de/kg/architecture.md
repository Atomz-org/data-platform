...
# zenith-de — architecture

**zenith** group · entity · warehouse `snowflake` · module `zenith_de`
...
flowchart LR
    subgraph LI["ingest"]
        ...
        I2["pipeline<br/>zenith_de"]:::platform
...
Query before reading: `kg_search`, `kg_neighbors`, `kg_path`, `impact_analysis`. Regenerate this file with `pf arch zenith zenith-de`.
