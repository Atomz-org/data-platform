...
Group: `jaffle`. The sister roster lives in the group card above —
...
| BI / WrenAI projection | `pf semantic mdl jaffle jaffle-shop` → `mdl/mdl.json` |
| Re-run every generated artefact | `pf bootstrap jaffle jaffle-shop` |
