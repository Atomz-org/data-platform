...
type: Reference
title: Kg Atlas
description: The graph answers questions about *this project*. It cannot tell you
  what it is
tags:
- kg
- graph
...
calls). See also [SEMANTICS.md](/reference/semantics.md) for the four layers the graph is
the join of, and [POLICY.md](/reference/policy.md) for how its governance plane is
resolved.
...
[POLICY.md](/reference/policy.md#what-is-deliberately-not-layered).
