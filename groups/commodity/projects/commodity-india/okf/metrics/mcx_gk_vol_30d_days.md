...
okf_x_kg_node: metric:mcx_gk_vol_30d_days
---

# Definition

* **Kind:** `simple`
* **Expression:** `count(garman_klass_vol_30d)`
...
* **Derived from it:** [avg_mcx_garman_klass_vol_30d](/metrics/avg_mcx_garman_klass_vol_30d.md)
