# Wren — semantic layer for jaffle/jaffle-shop
...
```bash
pf tool wren mdl jaffle jaffle-shop          # what the manifest contains
pf tool wren plan jaffle jaffle-shop "<sql>" # expand SQL through the MDL
pf tool wren query jaffle jaffle-shop "<sql>"
