...
description: 'How this platform governs the agents that work inside it: what stops
  an agent'
tags:
- governance
- ai-risk
...
layer — [`GOVERNANCE.md`](/reference/governance.md) (the provenance ledger),
[`POLICY.md`](/reference/policy.md) (the ontology policy overlay) and [`AIR.md`](/reference/air.md)
