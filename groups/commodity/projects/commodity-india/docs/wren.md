# Wren — semantic layer for commodity/commodity-india
...
```bash
pf tool wren mdl commodity commodity-india          # what the manifest contains
pf tool wren plan commodity commodity-india "<sql>" # expand SQL through the MDL
pf tool wren query commodity commodity-india "<sql>"
