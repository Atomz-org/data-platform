# Wren — semantic layer for globex/globex-core
...
```bash
pf tool wren mdl globex globex-core          # what the manifest contains
pf tool wren plan globex globex-core "<sql>" # expand SQL through the MDL
pf tool wren query globex globex-core "<sql>"
