---
type: Metric
title: Parkinson Volatility (annualised) — per Commodity
description: ''
okf_x_kind: derived
okf_x_model: fct_mcx_commodity_rollup_daily
okf_x_time_column: trade_date
okf_x_kg_node: metric:mcx_commodity_parkinson_vol
---
...
* **Built from:** [mcx_commodity_parkinson_variance](/metrics/mcx_commodity_parkinson_variance.md)
