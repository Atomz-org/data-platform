# Recce — dbt review for commodity/commodity-india
...
```bash
pf seed commodity commodity-india                 # build green
pf tool recce baseline commodity commodity-india  # capture that build as the baseline
#   ... change a model ...
pf seed commodity commodity-india
pf tool recce run commodity commodity-india       # diff against the baseline
pf tool recce serve commodity commodity-india     # read it in the Recce UI
```
...
pf artifacts pull commodity commodity-india      # baseline + review onto this machine
pf artifacts ls commodity commodity-india        # what has been published
```
