"""gold-api.com spot quotes for commodity-us: the precious-metal backup feed.

The declarative `rest_api` source is the group's (`commodity_shared.gold_api`);
this module annotates the resource it generates for the US catalog, which is
...
from commodity_us.catalog import COMMODITIES
