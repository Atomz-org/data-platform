...
BI-as-code for **hospital/mental-health**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build hospital mental-health    # regenerate from the semantic layer
pf report audit hospital mental-health    # mechanical quality score
