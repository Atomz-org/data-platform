...
| **group** | **here** | what every sister in zenith agrees on |
...
```
    ...
    pf evals zenith <project>          # contract tier + load every case
    pf evals zenith <project> --live   # grade against the real models
