...
5 groups · 9 projects · 23 toolkits · 23 pinned upstreams · 640 tests
...
flowchart TB
  subgraph SHARED["platform/ — shared by every project, never edited per company"]
    direction LR
    ENG["src/pf/<br/>30 commands · 16 groups"]
    TK["toolkits/<br/>23 craft toolkits"]
    TST["tests/<br/>5 groups · 640 tests"]
  ...
  VEN["vendor/<br/>23 pinned upstreams · read-only"]
