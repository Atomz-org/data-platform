# Wren — semantic layer for acme/acme-eu
...
```bash
pf tool wren mdl acme acme-eu          # what the manifest contains
pf tool wren plan acme acme-eu "<sql>" # expand SQL through the MDL
pf tool wren query acme acme-eu "<sql>"
