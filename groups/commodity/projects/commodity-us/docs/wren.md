# Wren — semantic layer for commodity/commodity-us
...
```bash
pf tool wren mdl commodity commodity-us          # what the manifest contains
pf tool wren plan commodity commodity-us "<sql>" # expand SQL through the MDL
pf tool wren query commodity commodity-us "<sql>"
