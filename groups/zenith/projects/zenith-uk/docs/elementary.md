# Elementary — data observability for zenith/zenith-uk
...
```bash
pf seed zenith zenith-uk                     # every build records itself
pf tool elementary run zenith zenith-uk      # first time: create the tables
pf tool elementary report zenith zenith-uk   # render the HTML report
pf tool elementary serve zenith zenith-uk    # read it in a browser
```
