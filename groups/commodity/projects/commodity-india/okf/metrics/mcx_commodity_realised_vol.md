---
type: Metric
title: Realised Volatility, Close-to-Close (annualised) — per Commodity
description: ''
okf_x_kind: derived
okf_x_model: fct_mcx_commodity_rollup_daily
okf_x_time_column: trade_date
okf_x_kg_node: metric:mcx_commodity_realised_vol
---
...
* **Built from:** [mcx_commodity_close_variance](/metrics/mcx_commodity_close_variance.md)
