...
| **group** | **here** | what every sister in commodity agrees on |
...
```
    ...
    pf evals commodity <project>          # contract tier + load every case
    pf evals commodity <project> --live   # grade against the real models
