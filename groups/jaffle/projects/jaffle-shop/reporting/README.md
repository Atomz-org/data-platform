...
BI-as-code for **jaffle/jaffle-shop**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build jaffle jaffle-shop    # regenerate from the semantic layer
pf report audit jaffle jaffle-shop    # mechanical quality score
