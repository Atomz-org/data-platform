# Recce — dbt review for commodity/commodity-us
...
```bash
pf seed commodity commodity-us                 # build green
pf tool recce baseline commodity commodity-us  # capture that build as the baseline
#   ... change a model ...
pf seed commodity commodity-us
pf tool recce run commodity commodity-us       # diff against the baseline
pf tool recce serve commodity commodity-us     # read it in the Recce UI
```
...
pf artifacts pull commodity commodity-us      # baseline + review onto this machine
pf artifacts ls commodity commodity-us        # what has been published
```
