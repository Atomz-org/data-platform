...
BI-as-code for **acme/acme-eu**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build acme acme-eu    # regenerate from the semantic layer
pf report audit acme acme-eu    # mechanical quality score
