...
BI-as-code for **commodity/commodity-india**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build commodity commodity-india    # regenerate from the semantic layer
pf report audit commodity commodity-india    # mechanical quality score
