...
**`generated/`** — written by `pf evals-gen hospital mental-health`. Each toolkit
...
**Everything else in `evals/cases/`** — yours. Cases that encode mental-health's own
...
## Commands
    ...
    pf evals-gen hospital mental-health      # (re)ground the toolkit templates
    pf evals hospital mental-health          # contract tier + load every case
    pf evals hospital mental-health --live   # grade against the real models
