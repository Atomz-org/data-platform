# Evals for commodity-us

Prompts are code; these are their tests.

## Two kinds of case live here

**`generated/`** — written by `pf evals-gen commodity commodity-us`. Each toolkit
...
**Everything else in `evals/cases/`** — yours. Cases that encode commodity-us's own
...
## Commands
    ...
    pf evals-gen commodity commodity-us      # (re)ground the toolkit templates
    pf evals commodity commodity-us          # contract tier + load every case
    pf evals commodity commodity-us --live   # grade against the real models
