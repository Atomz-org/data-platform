...
| **group** | **here** | what every sister in globex agrees on |
...
```
    ...
    pf evals globex <project>          # contract tier + load every case
    pf evals globex <project> --live   # grade against the real models
