...
| raw tables | ✓ 3 | `data/acme_eu.duckdb` | what the pipeline actually landed |
| **transform** | | | |
...
| **governance** | | | |
| project policy | ✓ 11 | `governance/policy.yaml` | the third ontology layer; may only tighten platform and group |
