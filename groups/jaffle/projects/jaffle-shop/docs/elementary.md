# Elementary — data observability for jaffle/jaffle-shop
...
```bash
pf seed jaffle jaffle-shop                     # every build records itself
pf tool elementary run jaffle jaffle-shop      # first time: create the tables
pf tool elementary report jaffle jaffle-shop   # render the HTML report
pf tool elementary serve jaffle jaffle-shop    # read it in a browser
```
