...
|---|---|---|
| ADR-0002 | accepted · **Stage:** `dialect` · **Date:** | ADR-0002 — Snowflake's semantics are the ones we pin, on every adapter |
| ADR-0003 | accepted · **Stage:** `review` · **Date:** | ADR-0003 — What the base/current diff found |
