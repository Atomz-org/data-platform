# Elementary — data observability for hospital/mental-health
...
```bash
pf seed hospital mental-health                     # every build records itself
pf tool elementary run hospital mental-health      # first time: create the tables
pf tool elementary report hospital mental-health   # render the HTML report
pf tool elementary serve hospital mental-health    # read it in a browser
```
