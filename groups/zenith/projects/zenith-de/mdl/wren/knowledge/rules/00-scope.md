# Scope — groups/zenith/projects/zenith-de

This workspace is one project of the `zenith` group. Every model in it is a
mart of `zenith-de` (MDL catalog `zenith`, schema `zenith_de`),
