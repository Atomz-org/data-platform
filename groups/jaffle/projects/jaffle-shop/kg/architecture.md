...
# jaffle-shop — architecture

**jaffle** group · entity · warehouse `duckdb` · module `jaffle_shop`
...
flowchart LR
    subgraph LI["ingest"]
        ...
        I2["pipeline<br/>jaffle_shop"]:::platform
        I3["raw tables<br/>57"]:::raw
    end
...
| capability docs | ✓ 12 | `docs/air.md` | one page per capability, explaining what it wired in |
...
**Capabilities:** `air`, `ducklake`, `elementary`, `evidence`, `expectations`, `github`, `governance`, `loops`, `okf`, `openmetadata`, `recce`, `snowflake`, `wren`
...
Query before reading: `kg_search`, `kg_neighbors`, `kg_path`, `impact_analysis`. Regenerate this file with `pf arch jaffle jaffle-shop`.
