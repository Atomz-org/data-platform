...
| `fct_us_contract_values_daily` | PriceObservation | quote_id | One benchmark price for one commodity at one point in time. Never summed. |
...
| `rpt_us_contract_board` | PriceObservation | quote_id | One benchmark price for one commodity at one point in time. Never summed. |
