# Recce — dbt review for hospital/mental-health
...
```bash
pf seed hospital mental-health                 # build green
pf tool recce baseline hospital mental-health  # capture that build as the baseline
#   ... change a model ...
pf seed hospital mental-health
pf tool recce run hospital mental-health       # diff against the baseline
pf tool recce serve hospital mental-health     # read it in the Recce UI
```
...
pf artifacts pull hospital mental-health      # baseline + review onto this machine
pf artifacts ls hospital mental-health        # what has been published
```
