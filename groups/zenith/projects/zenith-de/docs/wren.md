# Wren — semantic layer for zenith/zenith-de
...
```bash
pf tool wren mdl zenith zenith-de          # what the manifest contains
pf tool wren plan zenith zenith-de "<sql>" # expand SQL through the MDL
pf tool wren query zenith zenith-de "<sql>"
