...
4 groups · 8 projects · 23 toolkits · 22 pinned upstreams · 607 tests
...
flowchart TB
  subgraph SHARED["platform/ — shared by every project, never edited per company"]
    direction LR
    ENG["src/pf/<br/>31 commands · 16 groups"]
    TK["toolkits/<br/>23 craft toolkits"]
    TST["tests/<br/>5 groups · 607 tests"]
  ...
  VEN["vendor/<br/>22 pinned upstreams · read-only"]
...
|---|--:|--:|--:|--:|--:|--:|
| `acme/acme-eu` | 3 | 7 | 6 | 2 | 10 | 230 |
| `acme/acme-rollup` | 0 | 0 | 0 | 0 | 22 | 129 |
| `acme/acme-us` | 3 | 37 | 6 | 2 | 22 | 825 |
| `globex/globex-core` | 0 | 0 | 0 | 0 | 22 | 116 |
| `globex/globex-eu` | 0 | 0 | 0 | 0 | 22 | 116 |
| `jaffle/jaffle-shop` | 57 | 1088 | 19 | 6 | 22 | 4545 |
| `zenith/zenith-de` | 0 | 0 | 0 | 0 | 22 | 116 |
| `zenith/zenith-uk` | 0 | 0 | 0 | 0 | 22 | 116 |
