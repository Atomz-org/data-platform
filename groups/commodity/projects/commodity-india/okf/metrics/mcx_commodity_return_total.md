...
okf_x_kg_node: metric:mcx_commodity_return_total
---

# Definition

* **Kind:** `simple`
* **Expression:** `sum(return_1d)`
...
* **Derived from it:** [mcx_commodity_avg_daily_return](/metrics/mcx_commodity_avg_daily_return.md)
