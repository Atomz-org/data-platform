...
BI-as-code for **zenith/zenith-de**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build zenith zenith-de    # regenerate from the semantic layer
pf report audit zenith zenith-de    # mechanical quality score
