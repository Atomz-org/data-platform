# Recce — dbt review for acme/acme-us
...
```bash
pf seed acme acme-us                 # build green
pf tool recce baseline acme acme-us  # capture that build as the baseline
#   ... change a model ...
pf seed acme acme-us
pf tool recce run acme acme-us       # diff against the baseline
pf tool recce serve acme acme-us     # read it in the Recce UI
```
...
pf artifacts pull acme acme-us      # baseline + review onto this machine
pf artifacts ls acme acme-us        # what has been published
```
