# Elementary — data observability for zenith/zenith-de
...
```bash
pf seed zenith zenith-de                     # every build records itself
pf tool elementary run zenith zenith-de      # first time: create the tables
pf tool elementary report zenith zenith-de   # render the HTML report
pf tool elementary serve zenith zenith-de    # read it in a browser
```
