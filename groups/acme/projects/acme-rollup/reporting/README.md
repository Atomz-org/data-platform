...
BI-as-code for **acme/acme-rollup**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build acme acme-rollup    # regenerate from the semantic layer
pf report audit acme acme-rollup    # mechanical quality score
