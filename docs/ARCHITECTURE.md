...
4 groups · 8 projects · 23 toolkits · 21 pinned upstreams · 518 tests
...
flowchart TB
  subgraph SHARED["platform/ — shared by every project, never edited per company"]
    direction LR
    ENG["src/pf/<br/>29 commands · 14 groups"]
    TK["toolkits/<br/>23 craft toolkits"]
    TST["tests/<br/>5 groups · 518 tests"]
  ...
  VEN["vendor/<br/>21 pinned upstreams · read-only"]
...
| `jaffle/jaffle-shop` | 57 | 1088 | 19 | 6 | 22 | 4960 |
...
| `data-quality` | **yes** | — |
| `ducklake` | opt-in | 2 file(s) · settings · env: DUCKLAKE_METADATA |
