# Wren — semantic layer for acme/acme-us
...
```bash
pf tool wren mdl acme acme-us          # what the manifest contains
pf tool wren plan acme acme-us "<sql>" # expand SQL through the MDL
pf tool wren query acme acme-us "<sql>"
