...
# globex-eu — architecture

**globex** group · entity · warehouse `snowflake` · module `globex_eu`
...
flowchart LR
    subgraph LI["ingest"]
        ...
        I2["pipeline<br/>globex_eu"]:::platform
...
| CI workflow | ✓ | `.github/workflows/globex-eu.yml` | one workflow per project, composed from its capabilities' jobs |
...
Query before reading: `kg_search`, `kg_neighbors`, `kg_path`, `impact_analysis`. Regenerate this file with `pf arch globex globex-eu`.
