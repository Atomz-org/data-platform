# Wren — semantic layer for commodity/commodity-rollup
...
```bash
pf tool wren mdl commodity commodity-rollup          # what the manifest contains
pf tool wren plan commodity commodity-rollup "<sql>" # expand SQL through the MDL
pf tool wren query commodity commodity-rollup "<sql>"
