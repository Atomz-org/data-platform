...
type: Reference
title: Semantics
description: Four layers, each answering a question the one below it cannot. Built
  in this
tags:
- semantics
- metrics
...
[POLICY.md](/reference/policy.md).

The knowledge graph is the join of all four — its node kinds, its legal edges and
the traversals that answer real questions are mapped in [KG-ATLAS.md](/reference/kg-atlas.md).
