...
BI-as-code for **zenith/zenith-uk**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build zenith zenith-uk    # regenerate from the semantic layer
pf report audit zenith zenith-uk    # mechanical quality score
