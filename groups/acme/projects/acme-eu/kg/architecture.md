...
| data tests | ✓ 18 | `transform/models/_reporting__exposures.yml` | the assumptions the models are allowed to make |
...
| **delivery** | | | |
| exposures | ✓ 2 | `transform/models/_reporting__exposures.yml` | who reads the output — impact analysis stops at the mart without them |
