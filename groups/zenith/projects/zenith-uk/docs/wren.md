# Wren — semantic layer for zenith/zenith-uk
...
```bash
pf tool wren mdl zenith zenith-uk          # what the manifest contains
pf tool wren plan zenith zenith-uk "<sql>" # expand SQL through the MDL
pf tool wren query zenith zenith-uk "<sql>"
