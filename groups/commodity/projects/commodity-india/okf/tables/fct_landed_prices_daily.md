...
* **Read by:** `report_landed_cost` (data-platform), `report_metrics_avg_duty_local` (data-platform), `report_metrics_avg_landed_price_local` (data-platform), `report_metrics_avg_usd_fx_rate` (data-platform), `report_metrics_duty_local_total` (data-platform), `report_metrics_landed_price_days` (data-platform), and 2 more
