...
BI-as-code for **globex/globex-core**. Generated by `pf report build`, never
hand-maintained.
...
```bash
pf report build globex globex-core    # regenerate from the semantic layer
pf report audit globex globex-core    # mechanical quality score
