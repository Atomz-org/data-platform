...
flowchart LR
    ...
    subgraph LD["delivery"]
        ...
        D2["Evidence pages<br/>35"]:::exposure
    end
    I1 --> I2 --> I3 --> T1 --> T2
    T2 --> S1 --> D1 --> D2
    T2 --> S2
...
| marts | ✓ 10 | `transform/models/marts/core/dim_commodities.sql` | business entities at a declared grain — what metrics are built on |
