---
type: Metric
title: Garman–Klass Volatility (annualised) — per Commodity
description: ''
okf_x_kind: derived
okf_x_model: fct_mcx_commodity_rollup_daily
okf_x_time_column: trade_date
okf_x_kg_node: metric:mcx_commodity_gk_vol
---
...
* **Built from:** [mcx_commodity_gk_variance](/metrics/mcx_commodity_gk_variance.md)
