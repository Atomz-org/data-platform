...
```bash
pf tool okf build commodity commodity-india     # regenerate from the semantic layer
pf tool okf check commodity commodity-india     # stale or non-conformant? exits 1
pf tool okf graph commodity commodity-india     # does every page resolve in kg/graph.json?
pf tool okf weave commodity commodity-india     # ask the weaver for what the platform lacks
