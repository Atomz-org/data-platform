...
5 groups · 11 projects · 23 toolkits · 25 pinned upstreams · 900 tests
...
flowchart TB
  subgraph SHARED["platform/ — shared by every project, never edited per company"]
    direction LR
    ENG["src/pf/<br/>31 commands · 22 groups"]
    TK["toolkits/<br/>23 craft toolkits"]
    TST["tests/<br/>5 groups · 900 tests"]
  ...
  VEN["vendor/<br/>25 pinned upstreams · read-only"]
