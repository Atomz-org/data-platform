...
**`generated/`** — written by `pf evals-gen globex globex-core`. Each toolkit
...
**Everything else in `evals/cases/`** — yours. Cases that encode globex-core's own
...
## Commands
    ...
    pf evals-gen globex globex-core      # (re)ground the toolkit templates
    pf evals globex globex-core          # contract tier + load every case
    pf evals globex globex-core --live   # grade against the real models
