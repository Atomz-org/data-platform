...
5 groups · 11 projects · 26 toolkits · 26 pinned upstreams · 1187 tests
...
flowchart TB
  subgraph SHARED["platform/ — shared by every project, never edited per company"]
    direction LR
    ENG["src/pf/<br/>31 commands · 23 groups"]
    TK["toolkits/<br/>26 craft toolkits"]
    TST["tests/<br/>5 groups · 1187 tests"]
    ENT["entrypoints/<br/>container entrypoints"]
  end

  subgraph ENTITIES["groups/ — 5 groups, 11 projects"]
    direction LR
  ...
  VEN["vendor/<br/>26 pinned upstreams · read-only"]
...
| `commodity/commodity-india` | 6 | 29 | 109 | 110 | 32 | 741 |
...
|---|---|---|
| `air` | **yes** | 2 file(s) · ci: air-baseline · gate rules · settings |
...
| `github` | **yes** | 1 file(s) · ci: architecture, impact-gate, kg-current · gate rules · settings |
...
| `loops` | **yes** | 2 file(s) · gate rules · settings |
| `okf` | **yes** | 1 file(s) · gate rules · settings |
...
| `agent-context.yml` | hand-written, repo-wide |
| `ai-governance.yml` | hand-written, repo-wide |
| `bot-findings.yml` | hand-written, repo-wide |
| `claude-review.yml` | hand-written, repo-wide |
| `claude.yml` | hand-written, repo-wide |
| `commodity-india.yml` | generated per project — `pf bootstrap` |
| `commodity-rollup.yml` | generated per project — `pf bootstrap` |
| `commodity-us.yml` | generated per project — `pf bootstrap` |
| `copilot-setup-steps.yml` | hand-written, repo-wide |
