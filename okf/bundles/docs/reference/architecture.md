...
type: Reference
title: Architecture
description: GENERATED by `pf arch build`. Do not hand-edit — `pf arch check` fails
tags:
- architecture
- generated-docs
status: stable
...
5 groups · 11 projects · 23 toolkits · 24 pinned upstreams · 838 tests
...
flowchart TB
  subgraph SHARED["platform/ — shared by every project, never edited per company"]
    ...
    TST["tests/<br/>5 groups · 838 tests"]
