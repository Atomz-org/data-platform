...
# zenith-uk — architecture

**zenith** group · entity · warehouse `snowflake` · module `zenith_uk`
...
flowchart LR
    subgraph LI["ingest"]
        ...
        I2["pipeline<br/>zenith_uk"]:::platform
...
| CI workflow | ✓ | `.github/workflows/zenith-uk.yml` | one workflow per project, composed from its capabilities' jobs |
...
Query before reading: `kg_search`, `kg_neighbors`, `kg_path`, `impact_analysis`. Regenerate this file with `pf arch zenith zenith-uk`.
